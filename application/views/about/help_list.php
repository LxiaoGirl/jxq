...
<div class="mnx2">
<div class="help_w">
  <img src="../../../../assets/images/common/mb_ico.png">您当前所在的位置：<a href="<?php echo site_url(); ?>">首页</a> ><a href="<?php echo site_url('about/help'); ?>">帮助中心</a> ><span class="mb_blue"> <?php echo $category['category']; ?></span>
</div>
</div>
<!--面包屑导航 end-->
<div class="help_w">
...
<div class="help_list_main">
  ...
  <ul>
      <?php if($help_list):foreach($help_list as $k=> $v): ?>
          <li <?php if($k%2 == 0): ?>class="bgf2" <?php endif; ?>><a href="<?php echo site_url('about/help_detail?cat_id='.$cat_id.'&id='.$v['id']); ?>"><?php echo $k+1; ?> <?php echo $v['title']; ?></a></li>
      <?php endforeach;endif; ?>
      <?php ?>
  </ul>
</div>
