...
//            }
            ...
            if(typeof flag != "undefined" && flag==true && (isRealName != 1)){
                if (u.indexOf('Android') > -1 || u.indexOf('Linux') > -1) {//安卓手机
                    ...
                    window.location.href='<?php echo site_url('apps/home/real_name'); ?>';
                }
            }else{
...
//        var ajax_submit_button_obj = '';
//        if($(document).find("."+ajax_class_flag).length ==1){
//            $(document).ajaxStart(function(){
//                ajax_submit_button_obj = event.srcElement;
//                var class_str = $(event.srcElement).attr('class');  //event.fromElement event.toElement
//                if(class_str && class_str.indexOf(ajax_class_flag) != -1){ //标签的class包含标识
//                    switch (event.srcElement.tagName){
//                        case 'INPUT':
//                            ajax_submit_button_text = $(event.srcElement).val();
//                            $(event.srcElement).prop('disabled',true).val('提交中...');
//                            break;
//                        case 'BUTTON':
//                            ajax_submit_button_text = $(event.srcElement).html();
//                            $(event.srcElement).prop('disabled',true).html('提交中...');
//                            break;
//                        default:
//                    }
//                }
...
//                        case 'INPUT':
//                            var ajax_submit_button_time = setTimeout(function(){ $(ajax_submit_button_obj).prop('disabled',false).val(ajax_submit_button_text); clearTimeout(ajax_submit_button_time)},2000);
////                            $(ajax_submit_button_obj).prop('disabled',false).val(ajax_submit_button_text);
//                            break;
//                        case 'BUTTON':
//                            var ajax_submit_button_time = setTimeout(function(){ $(ajax_submit_button_obj).prop('disabled',false).html(ajax_submit_button_text); clearTimeout(ajax_submit_button_time)},2000);
//                            //$(ajax_submit_button_obj).prop('disabled',false).html(ajax_submit_button_text);
//                            break;
//                        default:
//                    }
//                }
