                            ...
                            <div class="nav_pop_body1">
                                <div class="top">
                                    ...
                                    <div class="right">
                                        ...
                                        <p><span><a href="<?php echo site_url('user/user/account_home'); ?>">我的账户</a></span>&nbsp;|&nbsp;<span><a href="<?php echo site_url('user/user/information'); ?>">消息<font class="msg-count">（0）</font></a></span></p>
                                    </div>
                                </div>
                                <div class="bottom">
