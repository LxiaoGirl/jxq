	...
	<div class="row clearfix">
		<div class="fo1 clearfix">
			...
			<div class="fo1_r fr">
				...
				<div class="down_l fl">
					<a href="/snowballapp.apk"><div class="down_btn1">下载Android版</div></a>
		...
		<div class="fo2">
			...
			<p class="fo-p3 tc">
				...
				<a href="https://trustsealinfo.websecurity.norton.com/splash?form_file=fdf/splash.fdf&dn=www.juxueqiu.com&lang=zh_cn" target = "_blank"><img class="a_q" src="../../../../assets/images/common/footer4.jpg" ><img class="a_f" src="../../../../assets/images/common/footer4_1.png"></a>
