...
<?php $this->load->view('common/head');?>    
    ...
    <div class="user_nav row">
        <a href="/index.php">首页</a>&nbsp;>&nbsp;<a href="javascript:void(0);">账户设置</a>&nbsp;>&nbsp;<a href="javascript:void(0);">基本信息-账户信息</a>
    </div>
    <div class="row user">
        <!--左侧通用-->
		...
		$('#name_sub').click(function(){
			...
			$.post('/index.php/user/user/Change_name'+condition,{},function(result){
                if(result.status == '10000'){
                    ...
                    $('#left_user_name_span').html(result.data);
                    $('.user_name').html(result.data);
					pop_sub_yzh($('.xgnc_1'),$('.xgnc_2'),$('.xgnc_2').find('.close'));
