...
?>
    ...
    <div class="row navbar-fixed-bottom">
        <a id="invest-button"
           href="<?php echo profile('uid') ? (($status == 2 && $due_date > time() && $buy_time < time() && $receive_rate < 100) ? site_url('mobiles/home/project_invest?borrow_no=' . $borrow_no) : 'javascript:void(0)') : 'javascript:check_to_login();'; ?>"
