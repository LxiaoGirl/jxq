    ...
    <form action="#" role="form" method="post" onsubmit="return false;">
        <div class="container  mt10">
            <div class="row  app_inputs form-group-lg">
                ...
                <div class="clears line"></div>
                <input placeholder="邀请码(选填)" <?php if($inviter_no): ?>style="display: none;" <?php endif; ?> name="invite_code" value="<?php echo $inviter_no?$inviter_no:''; ?>" type="text" class="input-group-lg form-control">
            </div>
        </div>
