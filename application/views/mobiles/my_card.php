                    ...
                    <tr>
                        ...
                        <td width="70">
                            <button type="button" class="btn btn-danger"
                                    onclick="check_to_login('<?php echo site_url('mobiles/home/my_card_unbind?card_no=' . $v['card_no']); ?>')">
                                解绑申请
                            </button>
                        </td>
                    </tr>
    ...
    $(function () {
        $('#bind-card').on('tap', function () {
            ...
            if ('<?php echo profile('security') ?>') {
                window.location.replace('/index.php/mobiles/home/recharge_form');
            } else {
                window.location.replace('/index.php/mobiles/home/security');
            }
        })
    });
</script>
