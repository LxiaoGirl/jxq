...
<script>
    ...
    $(function () {
        ...
        var get_data = function () {
            ...
            list_view.init('/index.php/mobiles/home/my_project' + condition, function (obj, v) {
                ...
                if(v.status == 2  || v.status == 3){
                    ...
                    // obj.find('.agree-a').attr('href', '<?php echo site_url("mobiles/home/terms?borrow_no=") ?>' + v.borrow_no);
                    obj.find('.agree-a').attr('href', 'https://www.zgwjjf.com/index.php/terms?borrow_no=' + v.borrow_no+'&money='+v.amounts);
                }
                obj.find('.project-info-a').attr('href', '<?php echo site_url("mobiles/home/project_detail?borrow_no=") ?>' + v.borrow_no);
            }, function () {
