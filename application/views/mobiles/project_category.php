    ...
    <table class="icons_table" width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td width="50%" valign="middle">
                <a href="/index.php/mobiles/home/project_list?category=1">
            ...
            <td width="50%" valign="middle">
                <a href="/index.php/mobiles/home/project_list?category=2">
        ...
        <tr>
            <td width="50%" valign="middle">
                <a href="/index.php/mobiles/home/project_list?category=3">
