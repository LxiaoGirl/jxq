...
<div class="container-fluid">
    <?php if (!empty($card)): ?>
        <?php foreach ($card as $v): ?>
            <div class="bg_white row"
                 onclick="javascript:window.location.href='<?php echo site_url('mobiles/home/recharge_form?card_no=' . $v['card_no']); ?>'">
    ...
    <?php else: ?>
        <div class="col-lg-12 mt20  mb20">
            <a href="<?php echo site_url('mobiles/home/recharge_form'); ?>" class="btn btn-danger   btn-lg btn-block">
                添加银行卡
            </a>
        </div>
    <?php endif; ?>
