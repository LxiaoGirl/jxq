  ...
  <div class="wrap" id="page1">
    ...
    <form id="myform" action="" method="post" onsubmit="return false;">
       ...
       <div class="box">
        ...
        <div class="box">
            <input type="checkbox" id="agree" checked style="    height: auto;width: auto;border: none;padding-left: 0;border: 0;"><a style="color:#639BFD;" href="<?php echo site_url('mobiles/jujianren/agree'); ?>">申请协议</a>
            <p class="agree"></p>
        </div>
...
$(function(){
    ...
    var check_phone = function(){
        if($('input[name="mobile"]').val()==""){
            ...
            $.ajax({
                type: 'POST',
                url: '/index.php/mobiles/jujianren/ajax_jujianren_check',
    ...
    $("#yuyin").keyup(function(){
        if($(this).val()==""){
            ...
            $.ajax({
                type: 'POST',
                url: '/index.php/mobiles/jujianren/ajax_authcode_check',
    ...
    $("#pass_btn").click(function(){
        if(chkpwd==true&&chkcpwd==true){
            button3_status(false);
            $("#pass_btn").html('提交中...');
            $.post('/index.php/mobiles/jujianren/ajax_jujianren_apply',{'mobile':mobiel,'password':$("#pwd").val(),'authcode':authcode},function(rs){
                button3_status(true);
                $("#pass_btn").html('确定');
                if(rs.code == 0){
