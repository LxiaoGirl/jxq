...
<script>
    ...
    $(function () {
        ...
        var get_data = function () {
            ...
            $.post('/index.php/apps/home/ajax_get_recharge_list' + condition, {}, function (result) {
                ...
                list_view.list(result.data, function (obj, v) {
                    if (v.status == 1) {
                        ...
                        if (v.type == 1) {
                            ...
                            obj.find('.r_status').removeClass('c_blue').addClass('c_red').html('<a href="<?php echo site_url('apps/home/recharge_confirm?recharge_no=');?>' + v.recharge_no + '" title="充值失败" style="color:#FF7100;" target="_self">充值失败</a>')
                        }
                    }
                });
                if (result.data) {
        ...
        $.post('/index.php/apps/home/my_balance', {}, function (rs) {
