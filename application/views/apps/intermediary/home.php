...
<body>
    ...
    <a href="<?php echo site_url('apps/intermediary/share_weixin'); ?>"><img class="fixbot left100" style="display:bolck; float:left" src="/assets/images/app/rejujianren.jpg" width="100%"></a>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var get_data =function(){
            ...
            $.post('/index.php/apps/intermediary/index'+condition,{},function(result){
                ...
                list_view.list(result.data,function(obj,v){
                    ...
                    obj.find(':first').attr('onclick','window.location.href="<?php echo site_url("apps/intermediary/user_invest_list?uid=") ?>'+ v.uid+'"');
        ...
        var get_data1 =function(){
            ...
            $.post('/index.php/apps/intermediary/index'+condition,{},function(result){
                ...
                list_view1.list(result.data,function(obj,v){
                    ...
                    obj.find(':first').attr('onclick','window.location.href="<?php echo site_url("apps/intermediary/settle_invest_list?real_month=") ?>'+ v.real_month+'&amount='+v.amount+'"');
                });
                if(result.data){
                    page_id1++;
