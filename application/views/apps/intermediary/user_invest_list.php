...
<body>
    <div class="con_wap">
        <div class="invest_top">
            <div class="left_invest_top">
                <div class="touxiang"><img src="<?php echo $user['avatar']?assets($user['avatar']):assets('images/personal/default-faceimage.png'); ?>"/></div>
            </div>
    ...
    <a href="<?php echo site_url('apps/intermediary/share_weixin'); ?>"><img class="fixbot" style="display:bolck; float:left" src="/assets/images/app/rejujianren.jpg" width="100%"></a>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var get_data =function(){
            ...
            $.post('/index.php/apps/intermediary/user_invest_list'+condition,{'uid':'<?php echo $uid; ?>'},function(result){
