...
class CI_DB_active_record extends CI_DB_driver {
     ...
     * @param   boolean the cache clause
	 * @return	object
	 */
	public function get($table = '', $limit = null, $offset = null, $cache = FALSE)
	{
		if ($table != '')
		{
			$this->_track_aliases($table);
		...
		$result = ( ! empty($cache)) ? $sql : $this->query($sql);
		$this->_reset_select();
		return $result;
	}
	 ...
	 * @return	string
	 */
	public function count_all_results($table = '', $cache = FALSE)
	{
		if ($table != '')
		{
			$this->_track_aliases($table);
