...
/*     if (curl_errno($curl)) {
   ...
   // $url='http://59.46.127.101:9446/paysnet/PayInterfaceI';// 提交网关地址
...
/* 	 public function testchuli(){
     ...
     */	
		...
		public function kt31040(){
				$MktCode="00000002";
				$type ="31040";
				//測試環境參數
				$MarketSerial =date('YmdHis');
				$VaccId ="6225882403001727";// 不是凱塔賬戶
				$PCustName ="寇琳";
				$DepositId ="10006";//招商銀行
				$BankAcc ="0122100613675";  //测试环境：0122100613675
				$RCustName ="SHENFA005805422";//测试环境：SHENFA005805422
				$MobiNo ="15840554054";//手机号码
				$CorType ="1";//證件類型，1身份證
				$CorID ="21102119900405005x";// 
				$ContNo ="Y000123210";// 
				$TrNum ="M8PAK";// 
				$Flag1 ="1";//操作标志 1新增；2修改；3删除
				$Flag2 ="0";//0：借记卡；1存折；2：对公帐号
				$Summary1 ="0";//记录
				$Summary2 ="0";//记录

				$xmldata="<?xml version='1.0'encoding='UTF-8'standalone='no'?><root><Pub><Version>3.0</Version><TradeCode>".$type."</TradeCode><Date>".date('Ymd')."</Date><Time>".date('His')."</Time><EntWay>I</EntWay><BankId>A14</BankId><TradeSrc>I</TradeSrc><MktCode>".$MktCode."</MktCode></Pub><Serial><MarketSerial>".$MarketSerial."</MarketSerial></Serial><FundAcc><VaccId>".$VaccId."</VaccId><CustName>".$PCustName."</CustName><DepositId>".$DepositId."</DepositId></FundAcc><BankAcc><BankAcc>".$BankAcc."</BankAcc><CustName>".$RCustName."</CustName></BankAcc><Client><MobiNo>".$MobiNo."</MobiNo><CorType>".$CorType."</CorType><CorID>".$CorID."</CorID></Client><ContractInfo><ContNo>".$ContNo."</ContNo><TrNum>".$TrNum."</TrNum></ContractInfo><FlagInfo><Flag1>".$Flag1."</Flag1><Flag2>".$Flag2."</Flag2></FlagInfo><SummaryInfo><Summary1>".$Summary1."</Summary1><Summary2>".$Summary2."</Summary2></SummaryInfo></root>";
				echo $xmldata;
...
<BankId>A14</BankId>
<TradeSrc>I</TradeSrc>
<MktCode>".$MktCode."</MktCode>
</Pub>
<Serial>
<MarketSerial>".$MarketSerial."</MarketSerial>
</Serial>
<FundAcc>
<VaccId>".$VaccId."</VaccId>
...
<Summary2/>
     ...
     */	
		...
		public function kt31041(){
				...
				$Summary1 ="0";//记录
				$Summary2 ="0";//记录
				$xmldata="<?xml version='1.0'encoding='UTF-8'standalone='no'?><root><Pub><Version>3.0</Version><TradeCode>".$TradeCode."</TradeCode><Date>".date('Ymd')."</Date><Time>".date('His')."</Time><EntWay>I</EntWay><BankId>A14</BankId><TradeSrc>I</TradeSrc><MktCode>".$MktCode."</MktCode></Pub><Serial><MarketSerial>".$MarketSerial."</MarketSerial></Serial><FundAcc><VaccId>".$VaccId."</VaccId><CustName>".$CustName."</CustName><DepositId>".$DepositId."</DepositId></FundAcc><BankAcc><BankAcc>".$BankAcc."</BankAcc></BankAcc><Client><MobiNo>".$MobiNo."</MobiNo></Client><ContractInfo><ContNo>".$ContNo."</ContNo></ContractInfo><SummaryInfo><Summary1/><Summary2/></SummaryInfo></root>";
				$data = $this->vpostdata($xmldata,$MktCode,$TradeCode);
				echo $baxmldata = base64_encode($xmldata);
				$baxmldata = urlencode($baxmldata);
				echo base64_decode($baxmldata);
				$result = $this->vpost($data);
				$configData = $this->geshihua($result);
				echo $data;
				var_dump($configData);
...
<TotalMon>".$TotalMon."</TotalMon>
</Transfer>
<Client>
<MobiNo>".$MobiNo."</MobiNo>
<CorType>".$CorType."</CorType>
<CorID>".$CorID."</CorID>
</Client>
<ContractInfo>
<ContNo>".$ContNo."</ContNo>
...
<SummaryInfo>
<Summary1>平安银行跨行入金摘要</Summary1>
<Summary2/>
</SummaryInfo>
</root>
     */	
	
		public function kt31042(){
				$MktCode="00000002";
				$TradeCode ="31042";
				//測試環境參數
				$MarketSerial =date('YmdHis');
				...
				$xmldata="<?xml version='1.0'encoding='UTF-8'standalone='no'?><root><Pub><Version>3.0</Version><TradeCode>".$TradeCode."</TradeCode><Date>".date('Ymd')."</Date><Time>".date('His')."</Time><EntWay>I</EntWay><BankId>A14</BankId><TradeSrc>I</TradeSrc><MktCode>".$MktCode."</MktCode></Pub><Serial><MarketSerial>".$MarketSerial."</MarketSerial></Serial><FundAcc><VaccId>".$VaccId."</VaccId><CustName>".$CustName."</CustName><DepositId>".$DepositId."</DepositId></FundAcc><BankAcc><BankAcc>".$BankAcc."</BankAcc></BankAcc><Transfer><TransferAmount>".$TransferAmount."</TransferAmount><TotalMon>".$TotalMon."</TotalMon></Transfer><Client><MobiNo>".$MobiNo."</MobiNo><CorType>".$CorType."</CorType><CorID>".$CorID."</CorID></Client><ContractInfo><ContNo>".$ContNo."</ContNo><TrNum>".$TrNum."</TrNum></ContractInfo><MoneyKind><MoneyKind>CNY</MoneyKind></MoneyKind><FlagInfo><Flag1>0</Flag1><Flag2>0</Flag2></FlagInfo><SummaryInfo><Summary1>平安银行跨行入金摘要</Summary1><Summary2/></SummaryInfo></root>";
				$data = $this->vpostdata($xmldata,$MktCode,$TradeCode);
				$result = $this->vpost($data);
				$configData = $this->geshihua($result);
				var_dump($configData);
...
public function kt31043(){
	$MktCode="00000002";
	$TradeCode ="31043";
	//測試環境參數
	$MarketSerial = date('YmdHis');
	$BillNo = "20150713134808";
				$VaccId ="6225882403001727";// 不是凱塔賬戶
				$CustName ="寇琳";
				$DepositId ="10006";//招商銀行
				$BankAcc ="0122100613675";  //测试环境：0122100613675
				...
				$xmldata="<?xml version='1.0'encoding='UTF-8'standalone='no'?><root><Pub><Version>3.0</Version><TradeCode>".$TradeCode."</TradeCode><Date>".date('Ymd')."</Date><Time>".date('His')."</Time><EntWay>I</EntWay><BankId>A14</BankId><TradeSrc>I</TradeSrc><MktCode>".$MktCode."</MktCode></Pub><Serial><MarketSerial>".$MarketSerial."</MarketSerial><BillNo>".$BillNo."</BillNo></Serial></root>";
				$data = $this->vpostdata($xmldata,$MktCode,$TradeCode);
				echo $xmldata;
				$result = $this->vpost($data);
				$configData = $this->geshihua($result);
...
<Summary2/>
	...
	public function kt31044(){
		...
		$Summary1 ="0";//记录
		$Summary2 ="0";//记录
		$xmldata="<?xml version='1.0'encoding='UTF-8'standalone='no'?><root><Pub><Version>3.0</Version><TradeCode>".$TradeCode."</TradeCode><Date>".date('Ymd')."</Date><Time>".date('His')."</Time><EntWay>I</EntWay><BankId>A14</BankId><TradeSrc>I</TradeSrc><MktCode>".$MktCode."</MktCode></Pub><Serial><MarketSerial>".$MarketSerial."</MarketSerial></Serial><FundAcc><VaccId>".$VaccId."</VaccId><CustName>".$CustName."</CustName></FundAcc><BankAcc><BankAcc>".$BankAcc."</BankAcc></BankAcc><Client><MobiNo>".$MobiNo."</MobiNo></Client><ContractInfo><ContNo>".$ContNo."</ContNo><TrNum>".$TrNum."</TrNum></ContractInfo><SummaryInfo><Summary1>平安银行跨行入金摘要</Summary1><Summary2/></SummaryInfo></root>";
		$data = $this->vpostdata($xmldata,$MktCode,$TradeCode);
		$result = $this->vpost($data);
		$configData = $this->geshihua($result);
		var_dump($configData);
