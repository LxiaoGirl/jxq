...
class Category_model extends CI_Model
{
    ...
    public function create()
    {
        ...
        $query = $this->c->insert(self::category, $data);
    ...
    public function delete()
    {
        ...
        $query = $this->c->delete(self::category, $temp['where']);
    ...
    public function update()
    {
        ...
        $temp['where'] = array('where' => array('cat_id' => $temp['cat_id']));
        $query = $this->c->update(self::category, $temp['where'], $temp['data']);
    ...
    public function show()
    {
        ...
        $data = $this->c->show_page(self::category, $temp['where']);
    ...
    public function get_category_info()
    {
        ...
        {
            $temp['where'] = array('where' => array('cat_id' => $temp['cat_id']));
            $data = $this->c->get_row(self::category, $temp['where']);
