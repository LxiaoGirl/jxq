            ...
            <form action="">
              <div class="form-group col-xs-4">
                <div class="input-group">
                  ...
                  <input type="text" name="keyword" class="form-control" placeholder="请输入操作人员姓名!">
                </div>
              </div>
              <button class="btn-primary btn">搜索</button>
              <div class="pull-right">
                <a href="<?php echo site_url('other/log');?>" title="返回列表" class="btn btn-default"><i class="fa fa-reply-all"></i>返回列表</a>
              </div>
            </form>
          </div>
          <div class="col-xs-12">
