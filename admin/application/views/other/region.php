            ...
            <form action="">
              <div class="form-group col-xs-4">
                <div class="input-group">
                  ...
                  <input type="text" name="keyword" class="form-control" placeholder="请输入地区名称!">
                </div>
              </div>
              <button class="btn-primary btn">搜索</button>
              <div class="pull-right"><a href="<?php echo site_url('other/region');?>" class="btn btn-default"><i class="fa fa-reply-all"></i>返回列表</a></div>
            </form>
          </div>
          <div class="col-xs-12">
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo site_url('other/region?parent_id='.$v['region_id']);?>" title="下级城市"><?php echo $v['region_name'];?></a></td>
                    </tr>
                    <?php endforeach;?>
                    <?php else:?>
                    <tr>
