            ...
            <div class="panel panel-midnightblue">
              ...
              <div class="panel-body">
				<table class="table table-hover">
						<?php $Days = floor((($data['rapay_time']-$data['confirm_time']+24*60*60)/3600/24));?>
                      <thead>                     
                      ...
                      <tr>
					   ...
					   <tr>
							...
							<td width="140px"><?php echo($data['amount']*0.002);?></td>
					  </tr>
					   <tr>
							<th width="140px">计划还款日期</th>
							<td width="140px"><?php echo date('Y/m/d',$data['confirm_time']+$data['months']*30*24*60*60);?></td>
					   ...
					   <tr>
							...
							<th width="140px">实收管理费(<?php echo($data['real_rate']);?>%)</th>
							<td width="140px"><?php echo $shishou=($data['amount']*$data['real_rate']/100*$Days/360);?></td>
							<th width="140px">管理费差额<?php echo 11111;?></th>
							<td width="140px"><?php echo $shishou-$yushou;?></td>
					  </tr>
					   <tr>
							<th width="140px">计划利息</th>
							<td width="140px"><?php echo($data['amount']*$data['rate']/100*$data['months']*30/360);?></td>
							<th width="140px">实际利息</th>
							<td width="140px"><?php echo($data['amount']*$data['rate']/100*$Days/360);?></td>
					  ...
					  <tr>
							...
							<th width="140px">应还本息管理费合计</th>
							<td width="140px"><?php echo($data['amount']+$data['amount']*$data['rate']/100*$Days/360+$data['amount']*0.06*$Days/360-$data['amount']*$data['real_rate']/100*$data['months']*30/360);?></td>
				  ...
				  <table class="table table-hover" style="margin-top:10px;">
					  ...
					  <tr>
							...
							<th width="140px">
							<?php if( $shengyu>0):?>					  
							<a href="http://120.24.208.200/admin/index.php/cron/repayment?day=7" title="还款" class="btn btn-default">还款</a>
							<?php endif;?>					  
							</th>
							<th width="140px"></td>
					  </tr>
