  ...
  <div id="page-content">
    <div id='wrap'>
      <div id="page-heading">
        ...
        <h1></h1>
        <div class="options"> <a href="<?php echo site_url('user/group');?>" class="btn btn-default"><i class="fa fa-reply-all"></i>返回列表</a> </div>
      </div>
      <div class="container">
        <div class="panel panel-midnightblue">
          <div class="panel-heading">
            <h4><?php echo ( ! empty($group_name)) ? $group_name : '添加部门';?></h4>
          ...
          <form action="" method="post" class="form-horizontal row-border" style="border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px;">
            <div class="panel-body collapse in">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" name="group_name" value="<?php echo ( ! empty($group_name)) ? $group_name : '';?>" class="form-control" placeholder="请输入部门名称"/>
                </div>
              </div>
              <div class="form-group">
