...
class Productcategory extends Login_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('other/productcategory', $data);
    }
    ...
    public function create()
    {
        ...
        if($this->form_validation->run() == TRUE)
        {
            ...
            if( ! empty($query))
            {
                redirect('other/productcategory', 'refresh');
            }
        }
    ...
    public function update()
    {
		...
		$data['sidebar']=$this->user->get_node_navigation();
        $this->load->view('other/productcategory_form', $data);
    }
}