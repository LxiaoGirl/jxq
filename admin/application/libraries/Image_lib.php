...
class CI_Image_lib {
	...
	function initialize($props = array())
	{
        ...
        $this->config_width = $this->width;
        $this->config_height = $this->height;
	...
	function image_process_gd($action = 'resize')
	{
		...
		$dst_img = $create($this->config_width, $this->config_height);
        $color = imagecolorallocate($dst_img, 255, 255, 255);// 设置背景色为白色
        imagefilledrectangle($dst_img, 0, 0, $this->config_width, $this->config_height, $color);
        
        if($this->config_width > $this->width)
        {
            $this->dst_x = round(($this->config_width - $this->width)/2);
        }

        if($this->config_height > $this->height)
        {
            $this->dst_y = round(($this->config_height - $this->height)/2);
        }
		...
		$copy($dst_img, $src_img, $this->dst_x, $this->dst_y, $this->x_axis, $this->y_axis, $this->width, $this->height, $this->orig_width, $this->orig_height);
