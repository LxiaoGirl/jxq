DateInput = (function($) {
	...
	DateInput.prototype = {
		build: function() {
			var monthNav = $('<p class="month_nav">' + '<span class="button prev" title="[Page-Up]">&#171;</span>' + ' <font class="month_name"></font> ' + '<span class="button next" title="[Page-Down]">&#187;</span>' + '</p>');
			...
			var yearNav = $('<p class="year_nav">' + '<span class="button prev" title="[Ctrl+Page-Up]">&#171;</span>' + ' <font class="year_name"></font> ' + '<span class="button next" title="[Ctrl+Page-Down]">&#187;</span>' + '</p>');
